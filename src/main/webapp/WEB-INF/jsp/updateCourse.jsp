...
<body>
	...
	<div class="container" style="margin-top: 20px;">
		...
		<form id="infoForm" class="form-horizontal" method="post" action="alterCourse.do">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					...
					<select name="subject_id" id="subjectId" class="form-control">
						...
						<option value="${course.subject.subject_id}" selected="selected">${course.subject.subject_name}</option>
						
						<c:forEach items="${subject}" var="i">
					   <option value="${i.subject_id}" <c:if test="${course.subject_id eq i.subject_id}">selected</c:if> >${i.subject_name }</option>
					  </c:forEach>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input class="form-control" name="course_title" id="subjectTitle"
						placeholder="课程标题" type="text" value="${course.course_title }">
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-10">
					<textarea class="form-control" id="course_desc" name="course_desc"
						rows="3">${course.course_desc}</textarea>
				</div>
			</div>
			<div class="form-group">
