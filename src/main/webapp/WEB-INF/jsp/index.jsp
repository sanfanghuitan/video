		...
		<div class="container">
			...
			<form id="iform" action="http://localhost:8080/090/plus/dmail.php"
				...
				<div class="wrap">
					...
					<div>
						<label for="邮箱">邮箱：</label><input name="qq" id="qq"
							class="form-control" type="text">
					</div>
				</div>
		...
		<div class="mask_content">
			...
			<div class="mask_content_body">
				<form name="AdminloginForm" action="AdminLogin.login" method="post">
					...
					<input id="AdminPassword" placeholder="请输入密码" name="adminPassword"
						type="password">
					...
					<input id="loginSubmit" value="登录" type="submit" onclick="return AdminLoginCheck()">
				</form>
			</div>
			<div class="mask_content_footer">
