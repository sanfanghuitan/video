...
<!--<base href="http://localhost:8080/Voids/">-->
    ...
    <link rel="icon" href="http://localhost:8080/static/z/favicon.png" type="image/png">
	...
	<menu>
		<div class="container clearfix">
			...
			<div id="user_bar">
				...
				<a  id="lay_out" href="userExit.do">退出</a>
			</div>
		</div>
	</menu>
</header>
        ...
        <div class="container">
            ...
            <div id="profile_tab">
                <ul class="profile_tab_header f_left clearfix">
                    <li><a href="updateUser.do?email=${user1.accounts}">更改资料</a></li>
                ...
                <div class="proflle_tab_body">
                    ...
                    <div class="proflle_tab_workplace clearfix">
                        <div class="profile_avatar_area">
		                         ...
		                         <img id="avatar" width="200px;" src="${user.imgurl}" alt="头像">
		                        
                            <p>				    
                                                                          欢迎回来！</p>
                        </div>
                        <ul class="profile_ifo_area">
                            <li><span class="dd">昵　称：</span><i>${user.nickname}</i></li>
                            <li><span class="dd">性　别：</span><i>${user.sex}</i>
                            </li>
                            <li><span class="dd">生　日：</span><i>${user.birthday}</i></li>
                            <li><span class="dd">邮　箱：</span><i>${user.accounts}</i></li>
                            <li><span class="dd">所在地：</span> <i>${user.address}</i></li>
