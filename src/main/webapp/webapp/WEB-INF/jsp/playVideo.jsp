...
<body class="w100" style="padding-top: 0px;">
 ...
 <c:if test="${user != null }">
		...
		<a onclick="JavaScript:addFavorite2()"><img
			...
			target="_blank"><img src="./static/z/we.png" draggable="false">后台管理</a>
		...
		<div id="content">
				...
				<div class="container">
					<div class="v-intro">
						...
						<div class="right">
							...
							<div class="avatar">
								<span
									style="background-image: url(${video.speaker.pic_url})"></span>
								<p>
									<b>讲师：${video.speaker.speaker_name}</b><br>
			...
			<div class="catalog">
				<div class="container">
					...
					<c:forEach items="${course.video}" var="i">
					<div class="chapter">
						<p class="biaoti">
							<a
								href="playVideo.do?video_id=${i.video_id}">${i.title}</a>
						</p>
